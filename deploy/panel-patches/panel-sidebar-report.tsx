    ...
    <>
      ...
      {open && (
        ...
        >
          ...
          >
            <h2 id="panel-report-title" className="text-lg font-semibold" style={{ color: "var(--fg)" }}>
              Report an issue
            </h2>
            ...
            <label className="mt-4 block text-xs font-semibold uppercase tracking-wider" style={{ color: "var(--muted)" }}>
              Describe the issue
            </label>
            <textarea
              value={note}
            ...
            {error && (
              <p className="mt-3 text-sm rounded-lg border px-3 py-2" style={{ borderColor: "var(--border)", color: "var(--danger)" }}>
                {error}
              </p>
            )}
            {msg && (
              <p className="mt-3 text-sm rounded-lg border px-3 py-2" style={{ borderColor: "var(--border)", color: "#4ade80" }}>
                {msg}
              </p>
            )}
