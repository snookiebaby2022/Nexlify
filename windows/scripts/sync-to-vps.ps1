...
lcd "$($cfg.ProjectRoot)"
cd "$($cfg.RemotePath)"
synchronize remote -delete=none -filemask="|node_modules/;.next/;.git/;.env;*.db;windows/;.license-keys/;src/instrumentation.ts;src/lib/cron-scheduler.ts" -transfer=binary
