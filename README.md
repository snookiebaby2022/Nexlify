...
**EPG → All Countries** registers iptv-org XMLTV URLs for every supported region. Use **Import all sources** first; run **Import + sync all** only when you want full programme data (slow).
