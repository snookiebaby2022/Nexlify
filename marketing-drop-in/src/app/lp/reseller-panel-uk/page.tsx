...
export default function LpResellerUkPage() {
  return (
    <LpCtaPage
      ...
      sub="Run lines, resellers, and Stripe billing on your own UK or EU VPS. Instant license keys, no shipping, and a full demo before you commit."
      bullets={[
        "GBP checkout via Stripe or Stripe",
        "7-day free trial — no card required",
        "Live demo at panel.demo.nexlify.live",
        "Deploy on London or Manchester VPS",
        "billing auto-provisioning included",
