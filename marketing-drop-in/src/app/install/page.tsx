...
import { PanelTroubleshooting } from "@/components/PanelTroubleshooting";
    ...
    <div className="mesh-bg min-h-screen">
      ...
      <div className="mx-auto max-w-4xl px-4 py-16 md:py-24">
        ...
        <p className="mt-4 max-w-2xl text-sm leading-relaxed text-slate-300 md:text-base">
          Deploy the full Nexlify IPTV panel on a fresh Ubuntu or Debian VPS. One line to install using your{" "}
          <strong className="text-slate-300">server IP</strong>, sign in with the admin password printed at the end,
          then paste your license key in the panel. Add a custom domain later under{" "}
          <strong className="text-slate-300">Admin → Settings → Domains & SSL</strong>. IP installs use plain{" "}
          <code className="text-violet-300">http://YOUR_SERVER_IP/login</code> on port 80 (no{" "}
