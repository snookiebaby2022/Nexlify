...
const INSTALL_STEPS = [
  ...
  },
  {
    ...
    text: "SSH in as root and run: curl -fsSL https://nexlify.live/install/panel.sh?v=190 | sudo bash -s -- --domain YOUR_SERVER_IP",
  },
  {
    name: "Sign in to the panel",
    text: "Open the login URL printed when install finishes (http://YOUR_SERVER_IP/login on port 80 — no :3000). Use admin and the generated password from /root/nexlify/install-credentials.",
  },
  {
  ...
  },
  {
    ...
    text: "Point DNS at your VPS and add the domain inside the panel under Admin → Settings → Domains & SSL, or re-run the installer with --email you@example.com.",
  },
];
