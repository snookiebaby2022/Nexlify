    ...
    <section className="relative overflow-hidden border-y border-violet-500/10 bg-gradient-to-b from-violet-950/20 to-[#080714] py-14 md:py-16">
      ...
      <div className="relative mx-auto max-w-4xl px-4 text-center">
        ...
        <p className="mt-6 text-xs text-[var(--muted)]">
          <Link href="/vs/xui-one" className="text-emerald-400 hover:text-emerald-300 underline">
            Nexlify vs XUI.one
          </Link>
          {" · "}
          <Link href="/best-iptv-reseller-panel" className="text-emerald-400 hover:text-emerald-300 underline">
