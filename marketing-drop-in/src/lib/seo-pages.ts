...
export const SEO_PAGES = {
  "/": {
    ...
    description:
      "Nexlify IPTV reseller panel and IPTV management software with native billing automation, anti-freeze playback, and 7-day trial. Worldwide resellers.",
    keywords: withCoreKeywords(["global IPTV panel", "best reseller panel", "Xtream panel"]),
    openGraph: {
      title: "IPTV Reseller Panel & Stripe billing | Nexlify",
      description:
        "IPTV reseller panel + IPTV management software. native billing, GBP & USD checkout, one-click installer.",
  ...
  "/demo": {
    ...
    description:
      "Try the Nexlify IPTV reseller panel live demo — IPTV management software with native billing flows. Same stack as production. No signup required.",
  ...
  "/pricing": {
    ...
    description:
      "Compare Nexlify IPTV reseller panel pricing vs legacy XUI.one forks. native billing included. IPTV management software from £50/mo with 7-day trial.",
    keywords: withCoreKeywords(["IPTV panel pricing", "XUI.one alternative"]),
  },
  "/features": {
    title: "IPTV Reseller Panel Features — Stripe billing & Tools",
    description:
      "Nexlify IPTV management software features: native billing, Anti-Freeze, reseller hierarchy, security, and billing tools for IPTV reseller panel operators.",
    keywords: withCoreKeywords(["Xtream panel", "best reseller panel"]),
  },
  "/install": {
    title: "Install IPTV Reseller Panel — IPTV Management Software",
    description:
      "One-command install for Nexlify IPTV reseller panel on Ubuntu/Debian. IPTV management software with native billing support. Node, PostgreSQL, PM2, nginx.",
  ...
  "/help": {
    ...
    description:
      "IPTV reseller panel help: native billing setup, IPTV management software licensing, VPS install, GBP/USD checkout, trial coupons, and support FAQs.",
    keywords: withCoreKeywords(["IPTV panel help", "best reseller panel"]),
  },
  "/register": {
    title: "Register IPTV Reseller Panel — 7-Day Free Trial",
    description:
      "Create your Nexlify IPTV reseller panel account. IPTV management software with native billing included. 7-day free trial, instant license delivery.",
    keywords: withCoreKeywords(["IPTV panel trial", "IPTV reseller registration"]),
  },
  "/updates": {
    title: "IPTV Reseller Panel Updates & Operator Guides",
    description:
      "Release notes and guides for Nexlify IPTV management software — native billing, IPTV reseller panel security, streaming, and billing updates for worldwide operators.",
    keywords: withCoreKeywords(["IPTV panel updates"]),
  },
  "/status": {
    title: "Nexlify Status — IPTV Reseller Panel & billing Uptime",
    description:
      "Check Nexlify IPTV reseller panel, native billing, licensing API, demo, and billing uptime. Real-time status for IPTV management software operators worldwide.",
  ...
  "/compare/xtream-panel": {
    ...
    description:
      "Compare Nexlify IPTV reseller panel vs Xtream panels. IPTV management software with native billing, Anti-Freeze, and security for resellers worldwide.",
    keywords: withCoreKeywords(["Xtream panel", "best reseller panel"]),
  },
  "/vs/xui-one": {
    title: "XUI.one Alternative — IPTV Reseller Panel & Stripe billing",
    description:
      "Nexlify vs XUI.one: IPTV reseller panel with migration tools, native billing, and IPTV management software. Telegram alerts and modern UX.",
  ...
  "/blog/migrate-from-xui-or-1-stream": {
    ...
    description:
      "Step-by-step migration from XUI.one to Nexlify IPTV reseller panel. native billing setup, preview import, and IPTV management software.",
    keywords: withCoreKeywords(["XUI migration"]),
  },
  "/lp/reseller-panel": {
    title: "IPTV Reseller Panel — Stripe billing & Trial",
    description:
      "Nexlify IPTV reseller panel with native billing, GBP/USD checkout, live demo, and 7-day trial. IPTV management software for resellers worldwide.",
  ...
  "/lp/reseller-panel-uk": {
    ...
    description:
      "Nexlify UK IPTV reseller panel with GBP billing, native billing, and IPTV management software. 7-day trial for British resellers.",
  ...
  "/affiliates": {
    ...
    description:
      "Refer IPTV reseller panel customers to Nexlify. IPTV management software with native billing — affiliate program for resellers worldwide.",
    keywords: withCoreKeywords(["IPTV affiliate", "reseller panel affiliate"]),
  },
  "/brand": {
    title: "Nexlify Brand Kit — IPTV Reseller Panel Assets",
    description:
      "Download Nexlify logos and assets for IPTV reseller panel marketing. IPTV management software and native billing branding for resellers worldwide.",
    keywords: withCoreKeywords(["Nexlify brand"]),
  },
  "/privacy": {
    title: "Nexlify Privacy Policy — IPTV Reseller Panel",
    description:
      "Privacy for Nexlify IPTV reseller panel and IPTV management software — cookies, analytics, billing, and native billing data for customers worldwide.",
    keywords: withCoreKeywords(["privacy policy", "GDPR", "CCPA"]),
  },
  "/terms": {
    title: "Nexlify Terms — IPTV Reseller Panel License",
    description:
      "Terms for Nexlify IPTV management software and IPTV reseller panel licenses. native billing usage, liability, and service boundaries.",
  ...
  "/refund-policy": {
    ...
    description:
      "Refund policy for Nexlify IPTV reseller panel licenses. IPTV management software with native billing — trial terms, chargebacks, and support.",
    keywords: withCoreKeywords(["refund policy"]),
  },
  "/livestream": {
    title: "Nexlify Live Stream — IPTV Reseller Panel Demos",
    description:
      "Live demos and updates for Nexlify IPTV reseller panel and IPTV management software. native billing sessions for resellers worldwide.",
    keywords: withCoreKeywords(["Nexlify live stream"]),
  },
  "/billing": {
    title: "Stripe billing — IPTV Reseller Panel Automation",
    description:
      "native billing for Nexlify IPTV reseller panel: auto-provision, renewals, suspensions. IPTV management software with Stripe/PayPal worldwide.",
  ...
  "/best-iptv-reseller-panel": {
    ...
    description:
      "Best IPTV reseller panel 2026: Nexlify vs XUI.one, 1-stream, Xtream UI. IPTV management software with native billing, pricing, and stability.",
  ...
  "/blog": {
    ...
    description:
      "Guides for IPTV reseller panel, native billing, and IPTV management software. Reseller playbooks and operator tips for service providers worldwide.",
    keywords: withCoreKeywords(["IPTV reseller guide", "become a reseller"]),
  },
  "/login": {
    title: "Sign In — Nexlify IPTV Reseller Panel Account",
    description:
      "Sign in to your Nexlify IPTV reseller panel account. Manage IPTV management software licenses, native billing, and billing.",
    noIndex: true,
  },
  "/admin": {
  ...
  "/admin/tickets": {
    ...
    description: "Admin support tickets for Nexlify IPTV reseller panel and native billing.",
    noIndex: true,
  },
  "/dashboard": {
    title: "My Licenses — Nexlify IPTV Reseller Panel",
    description:
      "Manage Nexlify IPTV reseller panel licenses, trials, and billing. IPTV management software with native billing.",
    noIndex: true,
  },
  "/support": {
    title: "Support — Nexlify IPTV Reseller Panel",
    description:
      "Support tickets for Nexlify IPTV reseller panel, native billing, and IPTV management software.",
    noIndex: true,
  },
  "/checkout/success": {
    title: "Checkout Complete — Nexlify IPTV Reseller Panel",
    description:
      "Order confirmation for Nexlify IPTV reseller panel license. IPTV management software with native billing.",
    noIndex: true,
  },
  "/order/success": {
