...
#
#   curl -fsSL 'https://nexlify.live/install/panel.sh?v=1.9.35' | sudo bash
#
...
Examples:
  curl -fsSL 'https://nexlify.live/install/panel.sh?v=1.9.35' | sudo bash
  curl -fsSL 'https://nexlify.live/install/panel.sh?v=1.9.35' | sudo bash -s -- --license NXLF1-XXXXX
  curl -fsSL 'https://nexlify.live/install/panel.sh?v=1.9.35' | sudo bash -s -- --domain panel.example.com --email admin@example.com
EOF
}
