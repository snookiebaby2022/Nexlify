...
#
#   curl -fsSL 'https://nexlify.live/install/panel.sh?v=1.9.36' | sudo bash
#
...
PANEL_CACHE_BUST="${PANEL_CACHE_BUST:-v1.9.36}"
...
Examples:
  curl -fsSL 'https://nexlify.live/install/panel.sh?v=1.9.36' | sudo bash
  curl -fsSL 'https://nexlify.live/install/panel.sh?v=1.9.36' | sudo bash -s -- --license NXLF1-XXXXX
  curl -fsSL 'https://nexlify.live/install/panel.sh?v=1.9.36' | sudo bash -s -- --domain panel.example.com --email admin@example.com
EOF
}
