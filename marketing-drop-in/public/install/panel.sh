...
#
#   curl -fsSL 'https://nexlify.live/install/panel.sh?v=2.0.87' | sudo bash
#
...
Examples:
  curl -fsSL 'https://nexlify.live/install/panel.sh?v=2.0.87' | sudo bash
  curl -fsSL 'https://nexlify.live/install/panel.sh?v=2.0.87' | sudo bash -s -- --license NXLF1-XXXXX
  curl -fsSL 'https://nexlify.live/install/panel.sh?v=2.0.87' | sudo bash -s -- --domain panel.example.com --email admin@example.com
EOF
}
