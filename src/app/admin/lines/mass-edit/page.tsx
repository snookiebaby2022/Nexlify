  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Link href="/admin/management/mass-edit" className="text-sm underline" style={{ color: "var(--muted)" }}>
          ← Mass edit
        </Link>
      </div>
          ...
          <thead style={{ background: "var(--bg-card)" }}>
            <tr>
              <th className="px-4 py-3 text-left">
                <input type="checkbox" checked={selected.size === lines.length && lines.length > 0} onChange={toggleAll} />
              </th>
