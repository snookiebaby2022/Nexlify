  ...
  return (
    <SettingsPanelForm
      ...
      sections={[
        ...
        {
          title: "DDoS shield",
          info: "Built-in flood protection on playback and Xtream API paths. Suspicious IPs are temporarily blocked automatically.",
          fields: [
            { key: "ddosShieldEnabled", label: "Enable DDoS shield", type: "yesno" },
            {
              key: "ddosShieldPerIpPerMin",
              label: "Max requests per IP / minute",
              type: "number",
              hint: "Applies to live, movie, player_api, get.php, stalker, and xmltv.",
            },
            {
              key: "ddosShieldBlockMinutes",
