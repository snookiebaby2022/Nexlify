  ...
  return (
    <form onSubmit={save} className="space-y-6 pb-8">
      ...
      <SettingsPanel title="Web & streaming">
        <div className="w-full space-y-4 mb-4 rounded-lg border p-4" style={{ borderColor: "var(--border)", background: "rgba(0,192,239,0.06)" }}>
          <p className="text-sm font-semibold">Recommended stack</p>
          <ul className="text-xs space-y-1 list-disc pl-4" style={{ color: "var(--muted)" }}>
            <li><strong>Nginx 1.29.0</strong> — HTTP/2, HTTP/3, QUIC (path below)</li>
            <li><strong>FFmpeg 8.0</strong> — select bundled-80 or 8.0_nvenc for CUDA/NVENC</li>
            <li><strong>MaxMind</strong> — GeoIP database for country/ISP network control</li>
          </ul>
        </div>
