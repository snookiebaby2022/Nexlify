  ...
  return (
    <SettingsForm
      ...
      fields={[
        ...
        {
          key: "autoBlockVpnToBlocklist",
          label: "Auto-add VPN/hosting IPs to blocklist",
          type: "checkbox",
          hint: "When blocked, permanently add the client IP to Management → Blocked IPs.",
        },
        { key: "fallbackIpApi", label: "Allow ip-api.co fallback", type: "checkbox" },
        {
          ...
          type: "textarea",
          hint: "Per-line allowed/blocked countries on Manage Lines. Blocklists under Management.",
        },
      ]}
    />
  );
