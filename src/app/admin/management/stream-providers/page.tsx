    ...
    <div className="space-y-6">
      ...
      >
        ...
        <div className="space-y-2 text-[var(--muted)]">
          ...
          <p>
            <strong>Generic URL (VOD)</strong> — Direct video file URLs (e.g., http://provider.com/movies/123.mp4).
          </p>
          <p>
            <strong>File host / CDN</strong> — Cloud storage or CDN (e.g., Bunny.net, Cloudflare R2, S3).
          </p>
          <p>
            <strong>Xtream VOD API</strong> — Xtream Codes compatible API for movies and series (e.g., http://provider.com:8080/player_api.php).
          </p>
        </div>
        <div className="text-xs text-[var(--muted)] border-t border-white/10 pt-2 mt-2">
          <strong>Common format examples:</strong>
          <ul className="list-disc list-inside mt-1 space-y-1">
            <li>Live: <code className="font-mono text-xs">http://host:port/live/user/pass/123.m3u8</code></li>
            <li>VOD: <code className="font-mono text-xs">http://host:port/movie/user/pass/123.mp4</code></li>
            <li>Series: <code className="font-mono text-xs">http://host:port/series/user/pass/123.mp4</code></li>
          </ul>
        </div>
      </div>
