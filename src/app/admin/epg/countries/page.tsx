    ...
    <div className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm mt-1" style={{ color: "var(--muted)" }}>
            {importedCount} / {total} xtream-masters country guides registered · {selected.size} selected
          </p>
        </div>
      ...
      >
        ...
        <p className="text-xs mb-3" style={{ color: "var(--muted)" }}>
          Public XMLTV guides from{" "}
          <a href="https://xtream-masters.com/epg/" target="_blank" rel="noreferrer" style={{ color: "var(--accent)" }}>
            xtream-masters.com/epg
          </a>
          . Use <strong>Import selected</strong> on a country below, or add a custom source with one of these URLs
          under Add EPG.
        </p>
