  ...
  return [
    ...
    },
    {
      ...
      group: {
        ...
        items: [
          ...
          { href: "/admin/watch-folders", label: "Watch Folders", section: "Auto-Sync" },
        ],
      },
    },
    {
    ...
    },
    {
      ...
      group: {
        ...
        items: [
          ...
          { href: "/admin/resellers/bouquets", label: "Bouquet Access (Resellers)", section: "Bouquets" },
        ],
      },
    },
    {
      ...
      group: {
        ...
        icon: coloredGroupIcon("live"),
        items: [
          { href: "/admin/streams/add", label: "Create Channel" },
    ...
    },
    {
      ...
      group: {
        ...
        items: [
          { href: "/admin/ai", label: "AI Hub" },
          { href: "/admin/ai/health-predictor", label: "Health Predictor" },
          { href: "/admin/ai/epg-scraper", label: "EPG Scraper" },
          { href: "/admin/ai/viewer-analytics", label: "Viewer Analytics" },
          { href: "/admin/ai/bouquet-builder", label: "Bouquet Builder" },
          { href: "/admin/ai/natural-language", label: "Natural Language" },
          { href: "/admin/ai/transcode-recommender", label: "Transcode Recommender" },
          { href: "/admin/ai/anomaly-detector", label: "Anomaly Detector" },
          { href: "/admin/ai/support-chat", label: "Support Chat" },
          { href: "/admin/ai/restream-detector", label: "Restream Detector" },
          { href: "/admin/ai/invoice-generator", label: "Invoice Generator" },
          { href: "/admin/ai/voice-query", label: "Voice Query" },
          { href: "/admin/ai/logo-generator", label: "Logo Generator" },
          { href: "/admin/ai/seasonal-recommender", label: "Seasonal Recommender" },
          { href: "/admin/ai/thumbnail-generator", label: "Thumbnail Generator" },
        ],
      },
    },
    {
    ...
    },
    {
      ...
      group: {
        id: "management",
        label: "Management",
        icon: coloredGroupIcon("management"),
        items: [
          { href: "/admin/management/mass-edit", label: "Mass Edit", section: "Mass Edit" },
          ...
          { href: "/admin/management/mass-edit/episodes", label: "Mass Edit Episodes", section: "Mass Edit" },
