  ...
  return [
    ...
    },
    {
      ...
      group: {
        ...
        items: [
          { href: "/admin/lines/add", label: "Add Line" },
          { href: "/admin/lines", label: "Manage Lines" },
          { href: "/admin/lines/mass-edit", label: "Mass Edit Lines" },
          { href: "/admin/line_activity", label: "Line Activity" },
          { href: "/admin/mag", label: "MAG Devices" },
          { href: "/admin/enigmas", label: "Enigma Devices" },
        ],
      },
    },
    {
