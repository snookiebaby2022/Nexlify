...
export const OPERATOR_FEATURES: OperatorFeature[] = [
  ...
  { label: "Access codes", href: "/admin/codes", group: "Lines", aliases: ["xui codes", "packages", "trial codes"] },
  { label: "Title Sync", href: "/admin/management/tools/title-sync", group: "Live", aliases: ["uk alias", "fhd hd sd", "xui title sync"] },
  { label: "YouTube Data API", href: "/admin/integrations/youtube", group: "Addons", aliases: ["search.list", "playlist import", "invidious"] },
  { label: "Channel Pulse", href: "/admin/streams/pulse", group: "Live", aliases: ["health board", "viewers epg probe"] },
  { label: "Logs hub", href: "/admin/logs", group: "Diagnostics", aliases: ["clear logs", "login logs", "expired lines"] },
