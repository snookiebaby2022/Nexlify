...
const DEFAULTS: Record<SettingGroup, Record<string, unknown>> = {
  ...
  "expiry-videos": {
    ...
    disabledLineVideoUrl: "",
    disabledLineRedirectUrl: "",
    disabledLineMessage: "This line is disabled. Contact your provider.",
  },
  "disk-monitor": {
  ...
  "nginx-cache": {
    ...
    cacheBypassHeader: "Authorization",
    proxyHideHeader: "Set-Cookie",
    proxyHideHeader2: "X-Powered-By",
    sliceEnabled: true,
    sliceSize: "1m",
    notes: "Nginx proxy cache for HLS/VOD segments. Reduces upstream load by caching at nginx level. Requires nginx compiled with ngx_cache_purge module.",
  },
  "ip2proxy": {
    enabled: false,
    databasePath: "/usr/local/share/ip2proxy/ip2proxy_ip.bin",
    blockVpn: false,
    blockDatacenter: false,
    blockProxy: false,
    blockTor: false,
    logDetection: true,
    actionOnDetection: "log",
  ...
  "allowed-domains": {
    ...
    domains: [] as string[],
    enforceOnEmbed: true,
    blockUnknownOrigin: false,
    allowLocalhost: true,
    customHeaders: [] as { name: string; value: string }[],
    notes: "Restrict which domains can embed or access the panel. Useful for preventing unauthorized iframe embedding. Checks Origin and Referer headers.",
  },
};
