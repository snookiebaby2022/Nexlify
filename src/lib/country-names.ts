/** ISO 3166-1 alpha-2 → full country name lookup (client-safe, no dependencies). */
...
export const COUNTRY_NAMES: Record<string, string> = {
  ...
  GW: "Guinea-Bissau", GY: "Guyana", HT: "Haiti", HM: "Heard Island", VA: "Vatican",
  ...
  RW: "Rwanda", BL: "Saint Barthélemy", SH: "Saint Helena", KN: "Saint Kitts and Nevis", LC: "Saint Lucia",
  MF: "Saint Martin", PM: "Saint Pierre", VC: "Saint Vincent", WS: "Samoa", SM: "San Marino",
  ...
  TC: "Turks and Caicos", TV: "Tuvalu", UG: "Uganda", UA: "Ukraine", AE: "United Arab Emirates",
  GB: "United Kingdom", US: "United States", UM: "United States Minor Islands", UY: "Uruguay", UZ: "Uzbekistan",
  VU: "Vanuatu", VE: "Venezuela", VN: "Vietnam", VG: "Virgin Islands, British", VI: "Virgin Islands, U.S.",
  WF: "Wallis and Futuna", EH: "Western Sahara", YE: "Yemen", ZM: "Zambia", ZW: "Zimbabwe",
  AX: "Åland Islands", BQ: "Bonaire", CW: "Curaçao", XK: "Kosovo",
};
