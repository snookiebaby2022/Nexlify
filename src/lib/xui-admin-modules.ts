...
export const XUI_ADMIN_MODULES: AdminModuleDef[] = [
  ...
  { slug: "stream_health", title: "Stream health", category: "Streams", redirect: "/admin/stream_errors?kind=unstable" },
  ...
  { slug: "mag_events", title: "MAG events", category: "Devices", redirect: "/admin/mag_events" },
  ...
  { slug: "settings_plex", title: "Plex settings", category: "Settings", redirect: "/admin/integrations/plex" },
  ...
  { slug: "player", title: "Player", category: "Integrations", redirect: "/admin/player" },

  { slug: "archive", title: "Archive", category: "Data", redirect: "/admin/content/archive" },
  { slug: "record", title: "Record", category: "DVR", redirect: "/admin/record" },
  { slug: "resize", title: "Resize", category: "Tools", redirect: "/admin/resize" },
  { slug: "review", title: "Review", category: "Content", redirect: "/admin/stream_review" },
  { slug: "hmac", title: "HMAC", category: "Security", redirect: "/admin/settings/security" },
