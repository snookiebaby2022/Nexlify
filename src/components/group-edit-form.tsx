        ...
        <div className="p-6 md:p-8 space-y-4">
          {tab === "details" && (
            <div className="space-y-4 max-w-2xl">
              ...
              <div className="rounded border p-4 space-y-3" style={{ borderColor: "var(--border)" }}>
                <h3 className="text-sm font-semibold">White-label (reseller portal)</h3>
                <FormField label="Custom logo URL">
                  <input
                    className={formInputClass}
                    style={formInputStyle}
                    value={form.config.whiteLabel.logoUrl}
                    onChange={(e) =>
                      setForm({
                        ...form,
                        config: {
                          ...form.config,
                          whiteLabel: { ...form.config.whiteLabel, logoUrl: e.target.value },
                        },
                      })
                    }
                ...
                <FormField label="Accent color">
                  <input
                    ...
                    style={{ borderColor: "var(--border)" }}
                    value={form.config.whiteLabel.accentColor || "#22d3ee"}
                    onChange={(e) =>
                      setForm({
                        ...form,
                        config: {
                          ...form.config,
                          whiteLabel: { ...form.config.whiteLabel, accentColor: e.target.value },
                        },
                      })
                    }
                  />
                ...
                <FormField label="Support email">
                  <input
                    className={formInputClass}
                    style={formInputStyle}
                    value={form.config.whiteLabel.supportEmail}
                    onChange={(e) =>
                      setForm({
                        ...form,
                        config: {
                          ...form.config,
                          whiteLabel: { ...form.config.whiteLabel, supportEmail: e.target.value },
                        },
                      })
                    }
                  />
            ...
            <div className="space-y-4 max-w-2xl">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                <FormField label="Subreseller price">
                  ...
                  />
                  <p className="text-xs mt-1" style={{ color: "var(--muted)" }}>
                    Credits deducted from the parent reseller when they add a sub-reseller. Set 0 for free creation.
                  </p>
                </FormField>
          ...
          {tab === "subresellers" && (
            <div className="space-y-4 max-w-2xl">
              <div
                ...
                style={{ borderColor: "var(--border)", background: "rgba(94,184,232,0.08)" }}
              >
                <p className="font-medium">About sub-resellers</p>
                <p style={{ color: "var(--muted)" }}>
                  Sub-resellers are child accounts under a main reseller. They receive a credit pool from their parent,
                  can create lines for their own customers, and inherit bouquet access unless you assign bouquets
                  directly. Use this tab to control credit transfers, visibility of other users&apos; subscriptions, and
                  how deep they can see the user tree.
                </p>
                <ul className="list-disc pl-5 space-y-1 text-xs" style={{ color: "var(--muted)" }}>
                  <li>
                    <strong>Subreseller price</strong> (Details tab) — credits charged when a reseller creates a new
                    sub-reseller account.
                  </li>
                  <li>
                    <strong>Minimum transfer amount</strong> — smallest credit top-up a parent can send to a child.
                  </li>
                  <li>
                    <strong>Own users only</strong> — sub-resellers see only lines they created, not sibling accounts.
                  </li>
                </ul>
              </div>
