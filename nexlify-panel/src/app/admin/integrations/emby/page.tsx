...
export default function EmbyIntegrationPage() {
  ...
  function load() {
    fetch("/api/admin/integrations?type=emby")
      .then((r) => r.json())
  ...
  async function add(e: React.FormEvent) {
    ...
    await fetch("/api/admin/integrations", {
      ...
      body: JSON.stringify({ type: "emby", ...form, token: form.apiKey }),
    });
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      ...
      <p className="text-sm opacity-70">
        Connect an Emby server (URL + API key). Sync imports movies and series as hosted streams.
      </p>
