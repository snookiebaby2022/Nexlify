...
cp -f "$ROOT/scripts/ensure-nginx-panel-hold.sh" "$INSTALL_DEST/scripts/ensure-nginx-panel-hold.sh"
cp -f "$ROOT/scripts/nexlify-watchdog.sh" "$INSTALL_DEST/scripts/nexlify-watchdog.sh"
cp -f "$ROOT/scripts/nexlify-streaming-guard.sh" "$INSTALL_DEST/scripts/nexlify-streaming-guard.sh"
cp -f "$ROOT/scripts/apply-prebuilt-update.sh" "$INSTALL_DEST/scripts/apply-prebuilt-update.sh"
...
cp -f "$ROOT/scripts/harden-iptv-install.sh" "$INSTALL_DEST/scripts/harden-iptv-install.sh"
cp -f "$ROOT/scripts/tune-capacity-50k.sh" "$INSTALL_DEST/scripts/tune-capacity-50k.sh"
cp -f "$ROOT/scripts/apply-iptv-production-stack.sh" "$INSTALL_DEST/scripts/apply-iptv-production-stack.sh"
mkdir -p "$INSTALL_DEST/scripts/lib"
cp -f "$ROOT/scripts/lib/nexlify-capacity.sh" "$INSTALL_DEST/scripts/lib/nexlify-capacity.sh"
...
cp -f "$ROOT/scripts/route-live-to-remote-edge.sh" "$INSTALL_DEST/scripts/route-live-to-remote-edge.sh"
cp -f "$ROOT/scripts/apply-live-edge-topology.sh" "$INSTALL_DEST/scripts/apply-live-edge-topology.sh"
cp -f "$ROOT/scripts/verify-playback-parity.sh" "$INSTALL_DEST/scripts/verify-playback-parity.sh"
cp -f "$ROOT/scripts/ensure-panel-env.sh" "$INSTALL_DEST/scripts/ensure-panel-env.sh"
cp -f "$ROOT/scripts/nexlify-resource-guard.sh" "$INSTALL_DEST/scripts/nexlify-resource-guard.sh"
cp -f "$ROOT/scripts/install-resource-headroom.sh" "$INSTALL_DEST/scripts/install-resource-headroom.sh"
cp -f "$ROOT/scripts/install-streaming-stability-cron.sh" "$INSTALL_DEST/scripts/install-streaming-stability-cron.sh"
