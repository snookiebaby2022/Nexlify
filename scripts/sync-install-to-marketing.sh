...
cp -f "$SCRIPTS/fix-remote-update-now.sh" "$INSTALL/"
cp -f "$SCRIPTS/fix-remote-update-now.sh" "$INSTALL/scripts/"
...
cp -f "$SCRIPTS/apply-panel-fast-update.sh" "$INSTALL/scripts/"
cp -f "$SCRIPTS/apply-prebuilt-update.sh" "$INSTALL/"
...
cp -f "$SCRIPTS/nexlify-watchdog.sh" "$INSTALL/scripts/"
cp -f "$SCRIPTS/nexlify-resource-guard.sh" "$INSTALL/scripts/"
cp -f "$SCRIPTS/install-resource-headroom.sh" "$INSTALL/scripts/"
cp -f "$SCRIPTS/install-streaming-stability-cron.sh" "$INSTALL/scripts/"
cp -f "$SCRIPTS/fix-update-worker-now.sh" "$INSTALL/scripts/"
cp -f "$SCRIPTS/fix-all-customer-updates.sh" "$INSTALL/scripts/"
cp -f "$SCRIPTS/fix-stuck-customer-panel.sh" "$INSTALL/scripts/"
cp -f "$SCRIPTS/ensure-customer-ip-env.sh" "$INSTALL/scripts/"
cp -f "$SCRIPTS/fix-customer-panel.sh" "$INSTALL/scripts/"
cp -f "$SCRIPTS/fix-customer-panel.sh" "$INSTALL/"
cp -f "$SCRIPTS/fix-panel-down-now.sh" "$INSTALL/scripts/"
cp -f "$SCRIPTS/fix-panel-down-now.sh" "$INSTALL/"
...
cp -f "$SCRIPTS/harden-iptv-install.sh" "$INSTALL/scripts/"
cp -f "$SCRIPTS/tune-capacity-50k.sh" "$INSTALL/scripts/"
cp -f "$SCRIPTS/apply-iptv-production-stack.sh" "$INSTALL/scripts/"
mkdir -p "$INSTALL/scripts/lib"
cp -f "$SCRIPTS/lib/nexlify-capacity.sh" "$INSTALL/scripts/lib/"
...
cp -f "$SCRIPTS/nexlify-nginx-release-ports.sh" "$INSTALL/scripts/"
...
cp -f "$SCRIPTS/route-live-to-remote-edge.sh" "$INSTALL/scripts/"
cp -f "$SCRIPTS/apply-live-edge-topology.sh" "$INSTALL/scripts/"
cp -f "$SCRIPTS/playback-topology.sh" "$INSTALL/scripts/"
cp -f "$SCRIPTS/panel-no-local-iptv-edge.sh" "$INSTALL/scripts/"
cp -f "$SCRIPTS/verify-live-no-redirect.sh" "$INSTALL/scripts/"
cp -f "$SCRIPTS/verify-playback-parity.sh" "$INSTALL/scripts/"
cp -f "$SCRIPTS/ensure-panel-env.sh" "$INSTALL/scripts/"
cp -f "$SCRIPTS/restore-panel-runtime-secrets.sh" "$INSTALL/scripts/"
cp -f "$SCRIPTS/panel-git-ref.sh" "$INSTALL/scripts/"
cp -f "$SCRIPTS/nexlify-git-checkout.sh" "$INSTALL/scripts/"
cp -f "$SCRIPTS/wait-panel-ready.sh" "$INSTALL/scripts/"
cp -f "$SCRIPTS/setup-dvr-storage.sh" "$INSTALL/scripts/"
...
cp -f "$SCRIPTS/vps-repair-standalone.sh" "$INSTALL/scripts/"
cp -f "$SCRIPTS/verify-standalone.sh" "$INSTALL/scripts/"
cp -f "$SCRIPTS/ensure-build-deps.sh" "$INSTALL/scripts/"
cp -f "$SCRIPTS/ensure-tsx.sh" "$INSTALL/scripts/"
cp -f "$SCRIPTS/run-cron-daemon.sh" "$INSTALL/scripts/"
cp -f "$SCRIPTS/build-cron.mjs" "$INSTALL/scripts/"
cp -f "$SCRIPTS/ensure-prisma-client.sh" "$INSTALL/scripts/"
cp -f "$SCRIPTS/ensure-pg-dump.sh" "$INSTALL/scripts/"
cp -f "$SCRIPTS/pg-dump-cron.sh" "$INSTALL/scripts/"
...
cp -f "$SCRIPTS/vps-sync-from-github.sh" "$INSTALL/"
cp -f "$SCRIPTS/vps-git-auth.sh" "$INSTALL/"
cp -f "$SCRIPTS/ensure-fleet-deploy-key.sh" "$INSTALL/scripts/"
